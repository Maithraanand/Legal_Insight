...
st.write("Upload a document to begin analysis.")
...
def load_all():
    ...
    client = OpenAI(api_key="YOUR_OPENAI_API_KEY")  # 🔴 PUT YOUR KEY
...
if "models" not in st.session_state:
    with st.spinner("Loading AI models... please wait (first time only)"):
